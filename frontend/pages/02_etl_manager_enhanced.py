...
with col1:
    st.metric("Total Pipelines", "24", "↑ 2")
with col2:
    st.metric("Running", "5", "Active")
with col3:
...
pipelines = [
    {"name": "sales_etl", "status": "running", "progress": 75, "last_run": "2 hours ago", "records": "125,432"},
    {"name": "customer_data", "status": "success", "progress": 100, "last_run": "1 hour ago", "records": "98,201"},
    {"name": "inventory_sync", "status": "running", "progress": 45, "last_run": "Just started", "records": "45,123"},
    {"name": "product_catalog", "status": "success", "progress": 100, "last_run": "3 hours ago", "records": "52,341"},
]
    ...
    <div class="pipeline-item">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                ...
                <p style="margin: 4px 0; color: #94a3b8; font-size: 0.9rem;">Last run: {pipeline['last_run']} | Records: {pipeline['records']}</p>
            </div>
            <div>
                <span class="status-running">{pipeline['status'].upper()}</span>
            </div>
        </div>
